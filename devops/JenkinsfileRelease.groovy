...
def gitId = 'github'
def gitRepo = 'https://github.com/ewilkins-csi/argo-local-sh'
...
withGit url: gitRepo, cred: gitId, branch: gitBranch, {
    try {
        ...
        slackSend color: "good",
                message: "argo-local-sh released successfully"

    } catch (err) {
        slackSend color: "danger",
                message: "argo-local-sh failed to release successfully"
        throw err
    }
}
